...
const ExpertTeam = () => {
  // Team member data array containing names and roles
  const teamMembers = [
  ...
  return (
    <div className="relative overflow-hidden bg-white">
      {/* ==================================== */}
      {/* Left decorative abstract shape */}
      {/* ==================================== */}
      <div className="absolute bottom-[190px] left-[-230px] hidden lg:block">
        <Image
          src="/assets/expert-team/left-side.png"
          alt="Spiral Image"
          width={522}
          height={587}
        />
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <div className="flex gap-2 mt-3 sm:mt-5">
                ...
                {/* Twitter/X link with vertical offset */}
                <a
                  href="#"
                ...
                >
                  <Image
                    src="/assets/expert-team/linkedin.png"
                    alt="twitter"
                    width={14}
                    height={14}
                  />
              ...
              {/* Team member name and role display */}
              ...
              {/* Decorative vector graphic at bottom */}
              <div className="absolute bottom-[-12px] right-[47px] hidden md:block">
                <Image
                  src="/assets/expert-team/Vector-25.png"
                  alt="vector"
                  width={180}
                  height={50}
                />
      ...
      {/* ==================================== */}
      {/* Right decorative mirrored shape */}
      {/* ==================================== */}
